...
def load_inference_graph():
    '''
    function to load frozen inference graph 
    and create tensorflow session
    ...
    return graph, sess # returns tensorflow session with loaded graph
...
def draw(scores, boxes, w, h, frame):
    ...
    if scores[0] > .2:
        ...
        # returns center of y coordinates and return
        return (y1 + y2) / 2    
